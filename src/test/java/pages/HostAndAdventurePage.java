...
public class HostAndAdventurePage extends TestBase {
	...
	public void enterDetailsFromExcel() throws InterruptedException {
			...
			test.info("Host an Adventure header is displayed");
			...
			test.info("Category is selected");
			...
			test.info("Minimum group size error is displayed");

			Assert.assertTrue(MaximumGroupErrorElement.isDisplayed());
			LoggerUtils.info("Minimum group size error is displayed");
			test.info("Maximum group size error is displayed");
			...
			test.info("Minimum group size is entered");
			...
			test.info("Maximum group size is entered");
			...
			test.info("Waiting for new tab to load....");
