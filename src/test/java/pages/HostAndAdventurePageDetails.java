...
public class HostAndAdventurePageDetails extends TestBase {
	...
	public void fillAdventureDetails() throws InterruptedException {
			...
			test.info("Difficulty is selected");
			...
			test.info("Not included is entered");
			...
			test.info("Days and Time is selected");
			...
			test.info("Availability is entered");
			...
			test.info("What qualifies you to give this tour? is entered");
			...
			test.info("Additional info is entered");
			...
			test.info("Cancellation is entered");
			...
			test.info("Meetup Location is selected");
			...
			test.info("Itinerary is entered");
			...
			test.info("Clicking on View Tour button");

			Thread.sleep(3000);
			LoggerUtils.info("Waiting for new window to open");
			test.info("Waiting for new window to open");
